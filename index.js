...
async function API(subject, count = 1, dateupload = 0) {
  let data = await fetch("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key="+key+"&format=json&in_gallery=1&media=photos&per_page=1&extras=url_o,date_upload&license=9&nojsoncallback=1&max_upload_date="+dateupload+"&page="+count+"&text="+subject);
